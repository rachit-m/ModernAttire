        ...
        <div class="row">
            ...
            <h16 class="w3-wide"><b>Handwork Collection</b></h16>
                    ...
                    <div class=" w3-large w3-text-grey" id="fabric_nav" style="font-weight:bold">
                        <a href="javascript:void(readData(''))"
                            class="w3-button w3-block w3-white w3-left-align">All</a>
                        ...
                        <div id="expand_Unstitched" class="w3-bar-block w3-hide w3-padding-large w3-medium">
                            ...
                            <a href="javascript:void(readData('Heavy Dupatta'))" class="w3-bar-item w3-button">Heavy
                                Dupatta</a>
                        </div>
                        <a href="javascript:void(readData('Dola'))" class="w3-bar-item w3-button">Dola Silk</a>
                        <a href="javascript:void(readData('Digital'))" class="w3-bar-item w3-button">Surat Digital
                            Prints</a>
                        <a href="javascript:void(readData('Jacquard'))" class="w3-bar-item w3-button">Banarsi
                            Jacquard</a>
                    </div>
                </nav>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="caption-container">
                ...
                <p>
                    ...
                    <a id="product_contact"
                        href="https://wa.me/919830702746?text=Hello%2C%20I%20am%20interested%20in%20product%20%20%2Cplease%20give%20me%20more%20details">Contact
                        on whatsapp for this product</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col" style="padding-top: 20%;">
                    <div>
                        <h1 id="latest" style="color: rgba(80, 24, 45, 1);">Best Seller of the Week</h1>
                ...
                <div class="col-9">
                    <div id="projects-slider" class="owl-theme owl-carousel">
                        <div class="project">
                            ...
                            <img src="images/cwa1ku1386a_01.jpg" alt="">
                            <div class="content">
                        ...
                        <div class="project">
                            <div class="overlay"></div>
                            <img src="images/cws2cd2523b_01_1.jpg" alt="">
                            <div class="content">
        ...
        <div class="w3-modal-content w3-animate-zoom" style="padding:32px">
            <div class="w3-container w3-white w3-center" id="catalog_update">
                ...
                <button type="button" class="w3-button w3-padding-large w3-red w3-margin-bottom"
                    onclick="sendEmail(document.getElementById('whatsapp_no').value);document.getElementById('newsletter').style.display='none';">Subscribe</button>
            </div>
        </div>
    </div>
